...
import Pdf.reporteDetalleCompra;
import javax.swing.SwingConstants;
import javax.swing.table.DefaultTableCellRenderer;
import javax.swing.table.DefaultTableModel;

public class mostrarLineaCompra extends javax.swing.JDialog {
...
private Compra com = new Compra();
    ...
    public mostrarLineaCompra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        nuevo();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setFont(new java.awt.Font("Segoe UI Light", 1, 18));
        jLabel6.setText("Total:");

        txtRazonSocial.setEditable(false);
        txtRazonSocial.setFont(new java.awt.Font("Tahoma", 1, 18));
        txtRazonSocial.setForeground(new java.awt.Color(204, 0, 0));

        jPanel2.setBackground(new java.awt.Color(0, 102, 102));

        jLabel7.setFont(new java.awt.Font("Segoe UI Light", 1, 18));
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Compra Nº");

        lblNumero.setFont(new java.awt.Font("Segoe UI Light", 1, 18));
        ...
        jLabel8.setFont(new java.awt.Font("Segoe UI Light", 1, 18));
        ...
        btnImprimir.setFont(new java.awt.Font("Segoe UI Light", 1, 14));
        ...
        setBounds((screenSize.width-626)/2, (screenSize.height-590)/2, 626, 590);
    }// </editor-fold>//GEN-END:initComponents

    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     int fila = reporteCompras.tablaReportes.getSelectedRow();
     lblNumero.setText(String.valueOf(reporteCompras.m.getValueAt(fila,0).toString()));
     txtRazonSocial.setText(String.valueOf(reporteCompras.m.getValueAt(fila,1).toString()));
     lblFecha.setText(String.valueOf(reporteCompras.m.getValueAt(fila,2).toString()));
     lblHora.setText(String.valueOf(reporteCompras.m.getValueAt(fila,3).toString()));
     txtTotal.setText(String.valueOf(reporteCompras.m.getValueAt(fila,4).toString()));
     com.dc.setNumeroCompra(Integer.parseInt(lblNumero.getText()));
     com.dc.mostrarLinea();
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
       reporteDetalleCompra rp = new reporteDetalleCompra(Integer.parseInt(lblNumero.getText()), txtRazonSocial.getText());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                mostrarLineaCompra dialog = new mostrarLineaCompra(new javax.swing.JFrame(), true);
